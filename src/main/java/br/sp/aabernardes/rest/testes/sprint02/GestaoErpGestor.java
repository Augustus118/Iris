...
public class GestaoErpGestor extends BaseTest {
	
	@BeforeClass
	public static void login() {
		
		// login e extrair token - Perfil Gestor
	...
	@Test
	public void cadastrarErpGestor() {
