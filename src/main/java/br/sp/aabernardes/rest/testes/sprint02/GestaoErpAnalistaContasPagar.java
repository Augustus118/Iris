...
public class GestaoErpAnalistaContasPagar extends BaseTest {
	
	@BeforeClass
	public static void login() {
		
		// login e extrair token - Perfil Analista de Contas a Pagar
	...
	@Test
	public void listarErpAnalistaContasPagar(){
	...
	@Test
	public void cadastrarErpAnalistaContasPagar() {
	...
	@Test
	public void editarErpAnalistaContasPagar() {
