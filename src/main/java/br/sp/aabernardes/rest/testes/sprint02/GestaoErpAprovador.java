...
public class GestaoErpAprovador extends BaseTest {
	
	@BeforeClass
	public static void login() {
		
		// login e extrair token - Perfil Aprovador
	...
	@Test
	public void listarErpAprovador(){
	...
	@Test
	public void cadastrarErpAprovador() {
	...
	@Test
	public void editarErpAprovador() {
